...
public static class SaveSystem 
{
    ...
    public static void SaveGameData(GameManager gameManager, Research research, ResearchManager researchManager)
    {
        ...
        using (var writer = new StreamWriter(savePath + saveName))
        {
            ...
            GameData gameData = new GameData(gameManager, research, researchManager);
